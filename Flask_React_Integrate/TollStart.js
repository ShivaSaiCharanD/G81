    ...
    return (
        <div className="home">
            <div>
                ...
                <button type="button" id='TollLog' class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#exampleModal">
                    LOG OUT
                </button>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <Link to="/"><button type="button" class="btn btn-danger" data-bs-dismiss="modal">Yes, Log Out</button></Link>
                            </div>
                        </div>
                    </div>
                </div>
