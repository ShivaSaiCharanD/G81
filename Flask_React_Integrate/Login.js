  ...
  return (
    <div id="LoginDiv">
      ...
      <form>
        ...
        <br />
        <input type="password" id="pwd" class = "btn btn-dark" placeholder="Enter your password here" name="pwd" required value={pwd}
          onChange={handlePwdChange}
        />
        <br></br>
      </form>
      {/* <input type="checkbox" id="LoginShowPwd" onClick={togglePasswordVisibility} /> Show Password */}
      <input  type="checkbox" class="btn-check" id="btncheck1" autocomplete="off" onClick={togglePasswordVisibility} /> 
      <label class="btn btn-outline-primary b" htmlFor="btncheck1">Show Password</label>
      <button type="button" id="LoginSubmit" onClick={handleSubmit} class="btn btn-outline-success">Submit</button>
